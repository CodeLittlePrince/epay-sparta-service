...
module.exports = {
  ...
  module: {
    ...
    rules: [
      ...
      // Convert all svgs to one sprite svg except the svg which the suffix is __base64
      {
        test: /\.(svg)(\?.*)?$/,
        ...
        use: [
          {
            ...
            options: {
              ...
              spriteFilename: isProduction
                ? 'static/font/sprite.[hash:8].svg'
                : 'static/font/sprite.svg'
            }
          },
          'svgo-loader'
        ]
  ...
  plugins: [
    ...
    new MiniCssExtractPlugin(
      {
        filename: isProduction ? 'static/css/[name].css' : 'static/css/[name].[contenthash:8].css',
        chunkFilename: isProduction ? 'static/css/[name].css' : 'static/css/[name].[contenthash:8].css'
      }
    )
  ]
}
